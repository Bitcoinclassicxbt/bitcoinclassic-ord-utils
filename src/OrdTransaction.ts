...
import { payments, networks, Psbt } from "bitcoinclassicjs-lib";
import type { Network } from "bitcoinclassicjs-lib";
import type { CreateSendXBT } from "./types.js";
...
export class OrdTransaction {
  ...
  private signTransaction: CreateSendXBT["signTransaction"];
  private calculateFee?: CreateSendXBT["calculateFee"];
  public changedAddress: string;
  private network: Network = networks.bitcoinclassic;
